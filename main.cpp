...
DWORD WINAPI main(PVOID base)
{
	...
	// note: create directories for configs, fonts, scripts etc.
	...
	main_folder = std::string(path) + crypt_str("\\flipix\\");
	configs_folder = std::string(path) + crypt_str("\flipix\\Configs\\");
	fonts_folder = std::string(path) + crypt_str("\\flipix\\Fonts\\");
	scripts_folder = std::string(path) + crypt_str("\\flipix\\Scripts\\");
	sounds_folder = std::string(path) + crypt_str("\\flipix\\Sounds\\");
