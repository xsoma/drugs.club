...
void C_ConfigManager::setup()
{
	...
	setup_item(&g_cfg.ragebot.double_tab_tolerance, 1, crypt_str("Ragebot.double_tab_tolerance"));
	setup_item(&g_cfg.ragebot.double_tab_override, 8, crypt_str("Ragebot.double_tab_override"));
	...
	setup_item(&g_cfg.ragebot.autoscope_distance, false, crypt_str("Ragebot.autoscope_distance"));
	setup_item(&g_cfg.ragebot.autoscope_distance_float, 0, crypt_str("Ragebot.autoscope_distance_float"));
	...
	for (auto i = 0; i < 8; i++)
	{
		...
		setup_item(&g_cfg.ragebot.weapon[i].accuracy_boost_amount, 1, std::to_string(i) + crypt_str("Ragebot.accuracy_boost_amount"));
		...
		setup_item(&g_cfg.ragebot.weapon[i].hitboxes, 5, std::to_string(i) + crypt_str("Ragebot.hitboxes"));
		setup_item(&g_cfg.ragebot.weapon[i].multipoints, 5, std::to_string(i) + crypt_str("Ragebot.multipoints"));
	...
	setup_item(&g_cfg.antiaim.hide_shots_shift_value, 11, crypt_str("Antiaim.hide_shots_shift_value"));
	...
	setup_item(&g_cfg.player.fake_wire_material, false, crypt_str("Player.fake_wire_material"));
	setup_item(&g_cfg.player.fake_wire_material_color, Color(255, 255, 255), crypt_str("Player.fake_wire_material_color"));

	setup_item(&g_cfg.player.player1_orig_material, false, crypt_str("Player.player1_orig_material"));
	...
	for (auto i = 0; i < 3; i++)
	{
		...
		setup_item(&g_cfg.player.type[i].wire_material, false, std::to_string(i) + crypt_str("Player.wire_material"));
		setup_item(&g_cfg.player.type[i].wire_material_color, Color(255, 255, 255), std::to_string(i) + crypt_str("Player.wire_material_color"));

		setup_item(&g_cfg.player.type[i].player_orig_material, false, std::to_string(i) + crypt_str("Player.player_orig_material"));
	...
	setup_item(&g_cfg.esp.indcolorl, Color(255, 255, 255), crypt_str("Esp.indcolorl"));
	setup_item(&g_cfg.esp.indcolorr, Color(255, 255, 255), crypt_str("Esp.indcolorr"));
	...
	setup_item(&g_cfg.esp.grenade_3dsmoke_color, Color(255, 255, 255), crypt_str("Esp.grenade_3dsmoke_color"));
	setup_item(&g_cfg.esp.grenade_3dfire_color, Color(255, 255, 255), crypt_str("Esp.grenade_3dfire_color"));
	setup_item(&g_cfg.esp.grenade_3dfire_color_enemy, Color(255, 255, 255), crypt_str("Esp.grenade_3dfire_color_enemy"));
	...
	setup_item(&g_cfg.esp.wireworld, false, crypt_str("Esp.wireworld"));
	setup_item(&g_cfg.esp.wireprop, false, crypt_str("Esp.wireprop"));
	...
	setup_item(&g_cfg.esp.sleeve_chams, false, crypt_str("Esp.sleeve_chams"));
	setup_item(&g_cfg.esp.sleeve_chams_type, 0, crypt_str("Esp.sleeve_chams_type"));
	setup_item(&g_cfg.esp.sleeve_chams_chams_color, Color(255, 255, 255), crypt_str("Esp.sleeve_chams_chams_color"));
	setup_item(&g_cfg.esp.sleeve_double_material, false, crypt_str("Esp.sleeve_double_material"));
	setup_item(&g_cfg.esp.sleeve_double_material_color, Color(255, 255, 255), crypt_str("Esp.sleeve_double_material_color"));
	setup_item(&g_cfg.esp.sleeve_wire_material, false, crypt_str("Esp.sleeve_wire_material"));
	setup_item(&g_cfg.esp.sleeve_wire_material_color, Color(255, 255, 255), crypt_str("Esp.sleeve_wire_material_color"));
	setup_item(&g_cfg.esp.sleeve_animated_material, false, crypt_str("Esp.sleeve_animated_material"));
	setup_item(&g_cfg.esp.sleeve_animated_material_color, Color(255, 255, 255), crypt_str("Esp.sleeve_animated_material_color"));


	setup_item(&g_cfg.esp.arms_wire_material, false, crypt_str("Esp.arms_wire_material"));
	setup_item(&g_cfg.esp.arms_wire_material_color, Color(255, 255, 255), crypt_str("Esp.arms_wire_material_color"));

	setup_item(&g_cfg.esp.weapon_wire_material, false, crypt_str("Esp.weapon_wire_material"));
	setup_item(&g_cfg.esp.weapon_wire_material_color, Color(255, 255, 255), crypt_str("Esp.weapon_wire_material_color"));


	setup_item(&g_cfg.esp.weapon_orig_material, false, crypt_str("Esp.weapon_orig_material"));
	setup_item(&g_cfg.esp.sleeve_orig_material, false, crypt_str("Esp.sleeve_orig_material"));
	setup_item(&g_cfg.esp.arms_orig_material, false, crypt_str("Esp.arms_orig_material"));
	...
	setup_item(&g_cfg.misc.wsadkeys, false, crypt_str("Misc.wsadkeys"));
	setup_item(&g_cfg.misc.retrack_speed, 0, crypt_str("Misc.retrack_speed"));
	...
	setup_item(&g_cfg.misc.logscolorl, Color(255, 255, 255), crypt_str("Misc.logscolorl"));
	setup_item(&g_cfg.misc.logscolorr, Color(255, 255, 255), crypt_str("Misc.logscolorr"));
	...
	setup_item(&g_cfg.misc.misctext, Color(0, 0, 0), crypt_str("misc.misctext"));
	setup_item(&g_cfg.misc.misccolorl, Color(0, 0, 0), crypt_str("misc.misccolorl"));
	setup_item(&g_cfg.misc.misccolorr, Color(0, 0, 0), crypt_str("misc.misccolorr"));
	setup_item(&g_cfg.misc.gradtype, 0, crypt_str("Misc.gradtype"));
	setup_item(&g_cfg.menu.watermark, false, crypt_str("Menu.watermark"));

	setup_item(&g_cfg.misc.verticalgrad, false, crypt_str("Menu.verticalgrad"));

	setup_item(&g_cfg.misc.alphal, 255, crypt_str("Misc.alphal"));
	setup_item(&g_cfg.misc.alphar, 255, crypt_str("Misc.alphal"));
...
void C_ConfigManager::save(std::string config)
{
	...
	auto get_dir = [&folder, &file, &config]() -> void
	{
		...
		if (SUCCEEDED(SHGetFolderPath(NULL, CSIDL_APPDATA, NULL, NULL, path)))
		{
			...
			file = std::string(path) + crypt_str("\\flipix\\Configs\\") + config;
		}
	};
...
void C_ConfigManager::config_files()
{
	...
	std::string path = folder + crypt_str("/*.dr");
	WIN32_FIND_DATA fd;
