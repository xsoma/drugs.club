...
struct Config 
{
	...
	struct Ragebot_t
	{
		...
		int double_tab_tolerance;
		int double_tab_override;
		struct weapon
		{
			bool hitchance = true;
	...
	struct Player_t 
	{
		...
		bool fake_wire_material;
		Color fake_wire_material_color;

		bool player1_orig_material;
		...
		struct type
		{
			...
			bool wire_material;
			Color wire_material_color;

			bool player_orig_material;
	...
	struct Visuals_t
	{
		...
		bool sleeve_chams;
		Color sleeve_chams_chams_color;
		bool sleeve_double_material;
		Color sleeve_double_material_color;
		bool sleeve_wire_material;
		Color sleeve_wire_material_color;
		bool sleeve_animated_material;
		Color sleeve_animated_material_color;
		int sleeve_chams_type;
		...
		Color grenade_3dfire_color;
		Color grenade_3dsmoke_color;
		Color grenade_3dfire_color_enemy;
		bool smoke_timer;
		...
		bool player_wire_material;
		Color player_wire_material_color;

		bool local_wire_material; 
		Color local_wire_material_color;
		...
		bool weapon_orig_material;
		Color weapon_orig_material_color;

		bool sleeve_orig_material;

		bool arms_orig_material;
